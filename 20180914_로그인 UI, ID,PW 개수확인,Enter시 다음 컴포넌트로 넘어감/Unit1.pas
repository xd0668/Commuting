...
uses
  ...
  Data.FMTBcd, Data.DB, Data.SqlExpr, Vcl.ExtCtrls, Vcl.Imaging.pngimage,
  Datasnap.DBClient, SimpleDS, Vcl.Grids, Vcl.DBGrids;
...
type
  TForm1 = class(TForm)
    ...
    procedure Edit2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);         // Edit2 에 대한 KeyPress
